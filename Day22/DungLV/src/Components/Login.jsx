            ...
            <div className="layout__container">
                ...
                <form className="form" method="POST">
                    <div className="form__input">
                        <svg className="form__icon" width="13.04" height="13.91" viewBox="0 0 14 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="form__input form__input--password">
                        <svg className="form__icon" width="10.22" height="18.68" viewBox="0 0 12 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <fieldset>
                    <legend className="layout__or">Or</legend>
                </fieldset>
                <Link to="/" className="btn btn--signup">Log In</Link>
