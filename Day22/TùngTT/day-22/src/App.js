        ...
        <div className="container_header">
          <div className="navbar">
            ...
            <div className="navbar__battery">
              <img src={cellular} className="navbar__icon navbar--icon--cellular" alt="Cellular"></img>
              <img src={wifi} className="navbar__icon navbar--icon--wifi" alt="Wifi"></img>
              <img src={battery} className="navbar__icon navbar--icon--battery" alt="Battery"></img>
            </div>
          </div>
        ...
        <div className="container__content">
          <form className="input__field">
            <div className="btn input--content">
              ...
              <input type="text" placeholder="johnsondoe@nomail.com"></input>
            </div>
            <div className="btn input--content">
              <img src={key} alt="key"></img>
              <input type="password" minlength="8" required placeholder="*****************"></input>
            </div>
            <div className="btn input--content">
