...
export default function StudentList(props) {
  ...
  const handleFilter = () => {
    ...
    data = student.filter(o => o.full_name.toLowerCase().includes(name.toLowerCase()));
    if (gender.length !== 0) {
      ...
      <Container maxWidth="md">
        <Box className={classes.box}>
          <FormControl className={classes.formControl}>
            <TextField placeholder="search by name..." margin="normal" onChange={e => setName(e.target.value)} />
          </FormControl>
          <FormControl className={classes.formControl}>
          ...
          <FormControl className={classes.formControl}>
            <TextField onChange={e => setAge(e.target.value)} placeholder="Age" margin="normal" type="number" />
          </FormControl>
