...
import { getTasks } from "../getAPI/getAPI";
...
function Report() {
  ...
  console.log(formatNowDay(PROCESS_DAY_GROUP(data).reverse()[0].date));
  console.log(formatNowDay(new Date()));
  if (1) {
  }
