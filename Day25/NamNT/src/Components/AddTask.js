...
import { getTasks, getTags, createTasks, updateTasks } from "../getAPI/getAPI";
import {
  PROCESS_DAY_GROUP,
  chooseTag,
...
function AddTask(props) {
  ...
  return (
    <>
      <header className="border-bottom border-dark header__countTime">
        <div className="header d-flex justify-content-between">
          <div className="header__left col-6">
              <input
                className="header__title border-0"
                type="text"
          ...
          <div className="header__right col-6 d-flex justify-content-end align-items-center">
            <div className="header__icon mx-2">
              <i
